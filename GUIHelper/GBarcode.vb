...
Public Module GBarcode
    Public Function Code128(ByVal TheText As String, ByVal CodeLetter As String) As Image
        ...
        GraphZ.DrawString(TheText, New Font("arial", 11, FontStyle.Regular), New SolidBrush(Color.Black), 20, 40)
    ...
    ''
    '' This is a decoder
    Function DecodeToString(barcode As Image) As String
        Dim bc As New Barcode.BarcodeDecoder
        Dim re As Barcode.Result = bc.Decode(barcode)
        Return re.Text
    End Function
End Module
